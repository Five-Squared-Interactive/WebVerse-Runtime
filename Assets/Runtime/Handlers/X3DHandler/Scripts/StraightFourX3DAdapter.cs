...
namespace FiveSQD.WebVerse.Handlers.X3D
{
    ...
    public class StraightFourX3DAdapter : MonoBehaviour, IX3DWorldAdapter
    {
        ...
        public void SetBackground(X3DBackgroundSettings settings)
        {
            ...
            // Set sky color using SetSolidColorSky
            EnvironmentManager.SetSolidColorSky(settings.SkyColor);

            // TODO: Handle skybox textures if provided
            // This would require loading the textures asynchronously and creating a skybox material
        }
